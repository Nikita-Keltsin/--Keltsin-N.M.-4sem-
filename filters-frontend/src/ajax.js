/**
 * Класс Ajax — обёртка над XMLHttpRequest.
 *
 * Почему коллбеки?
 * XHR асинхронный: ответ от сервера приходит через какое-то время.
 * Мы передаём функцию (коллбек), которая будет вызвана,
 * когда ответ наконец придёт.
 *
 * Сигнатура коллбека: callback(data, statusCode)
 */
class Ajax {
    /**
