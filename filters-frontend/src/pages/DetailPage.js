 ...
 * Данные фильтра запрашиваются с сервера по ID через XHR GET /filters/:id,
 * а не берутся из локального mockData.
 */
export class DetailPage {
    ...
    render() {
        ...
        // XHR GET /filters/:id — коллбек вызовется когда ответ придёт
