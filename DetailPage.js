...
export class DetailPage {
    ...
    loadData() {
        ajax.get(filterUrls.getFilterById(this.id), (data, status) => {
            if (status === 200 && data) {
                ...
                document.getElementById('detail-content').innerHTML = '<p style="color:red; font-size:1.5rem;">Фильтр не найден</p>';
            }
        });
    }
    ...
    initThreeJS() { // без изменений, но можно оставить как есть
